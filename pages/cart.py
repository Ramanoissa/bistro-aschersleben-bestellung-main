...
# Beispiel-Warenkorb-Daten (später durch echte Daten ersetzen)
cart_items = []

def CartPage(page: ft.Page):
    def update_cart():
                        ...
                        content=ft.Row([
                            ...
                            ft.Column([
                                ...
                                ft.Row([
                                    ...
                                    ft.Text("1"),  # TODO: Implementiere Mengenauswahl
                                    ft.IconButton(
                                        icon=ft.Icons.ADD,
    ...
    def remove_from_cart(item):
        if item in cart_items:
            ...
            update_cart()
            page.show_snack_bar(ft.SnackBar(content=ft.Text(f"{item['name']} wurde aus dem Warenkorb entfernt!")))
